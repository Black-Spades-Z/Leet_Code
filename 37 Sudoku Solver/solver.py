...
class Solution:
    ...
    def solveSudoku(self, board: List[List[str]]) -> None:
        ...
        self.boxes = self.box_devider(self.board)
        print('Boxes', *self.boxes, sep='\n')
        dot_list = list(self.dot_detector(self.board))
        print('Dot List \n' ,dot_list)
        self.copy_board = self.number_filler(dot_list, self.board)
        print('Board', *self.copy_board, sep='\n')
        for items in dot_list:
            print(self.copy_board[items[0]][items[1]])
